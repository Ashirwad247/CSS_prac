...
import { updatePipes, setupPipes, getPassedPip , getPiprec} from "./pipe.js"
...
function checkLose(){
    ...
    const insidePipe = getPiprec().some(rect => isCollision(birdRect, rect))
...
function handleLose(){
    ...
    subtitle.textContent = `${getPassedPip()} Pipes`
    document.addEventListener("keypress", handleStart, { once:true })
